# serverless-api/src/services/chat/generators/chat_generator.py
...
class ChatGenerator(BaseGenerator):
    ...
    def _get_component_config(self, component: str, tier: int) -> Dict[str, Any]:
        ...
        component_adjustments = {
            'standardsAddressed': {"temperature": -0.2},  # More precise
            'markupProblemSets': {"temperature": 0.1, "max_tokens": 1000},  # More creative
            'pedagogicalContext': {"max_tokens": 500}  # Shorter responses
        }
